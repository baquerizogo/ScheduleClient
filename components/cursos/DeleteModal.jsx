...
const DeleteModal = ({data, index}) => {
    ...
    const { deleteCourse } = coursesContext; //Funciones Context
            ...
            <div className="modal-dialog modal-dialog-centered" role="document" >
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title text-danger" id="exampleModalLongTitle" > Eliminar curso</h5>
                        <button type="button" className='close text-danger' data-dismiss="modal" aria-label="Close" >
                            <span aria-hidden="true"> &times; </span>
                        </button>
                    </div>
                    <div className="modal-body">
                        {`¿Está seguro que desea eliminar el curso ${data.name}?`}
                    </div>
