...
const ScheduleForm = () => {
    ...
    const { checkForm, setData, updateSchedule, activeSchedule, clearData, inicio, fin, id_parallel, id_course, newForm, data, modality, courseName, parallelName, errorForm } = schedulesContext;
    ...
    const saveSchedule = e => {
        ...
        updateSchedule(object, activeSchedule[0]._id);
        clear();
        clearData();
    }
